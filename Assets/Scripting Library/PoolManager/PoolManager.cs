...
public class PoolManager : MonoReferenceable
{
    ...
    public PoolItem Get<T>(Transform parent = null, bool enable = true) => Get(typeof(T), parent, enable);
    public PoolItem Get(Type keyType, Transform parent = null, bool enable = true)
    {
        PoolItem item = null;
